...
function main(ev) {
	...
	function draw() {
		...
		ctx.moveTo(0, 0);
		ctx.moveTo(-26, -55);
		ctx.quadraticCurveTo(0, -90, 19, -55);
		ctx.lineTo(0, 0);
		ctx.fillStyle = "rgba(198, 212, 5, 0.65)";
		ctx.fill();
		ctx.stroke();
		...
		ctx.beginPath();
		ctx.arc(300, 110, 57, 0, 2 * Math.PI);			//พระอาทิตย์
		ctx.fillStyle = "rgba(218, 225, 12, 1)";
		ctx.fill();
		ctx.stroke();

		ctx.beginPath();
		ctx.moveTo(30, 300);
		ctx.bezierCurveTo(300, 50, 50, 300, 800, 190);		//ภูเขาขวา
		ctx.lineTo(800, 300);
		ctx.lineTo(350, 300);
		ctx.fillStyle = "rgba(36, 122, 14, 1)";
		ctx.fill();
		ctx.stroke();
		...
		ctx.beginPath();
		ctx.moveTo(0, 200);
		ctx.quadraticCurveTo(300, 250, 400, 300);		//ภูเขาซ้าย
		ctx.lineTo(0, 300);
		ctx.lineTo(0, 200);
...
// ...existing code...
        ...
        // ข้าวเรียงเป็นแถวทางฝั่งต้นไม้ 
        const grassPositions = [];
        // กำหนดให้หญ้าอยู่แถวๆ x: 60 ถึง 220, y: 570
        for (let row = 0; row < 4; row++) {
            let y = 570 - row * 15;
            for (let x = 50 ; x <= 210 ; x += 30) {
        ...
        grassPositions.forEach(pos => {
            ...
            ctx.lineTo(pos.x, pos.y - 25); // ข้าว
...
ctx.translate(360, 350);							//คลื่นน้ำไหล
		ctx.beginPath();
		ctx.moveTo(-50, 0);
		...
		ctx.translate(360, 400);							//คลื่นน้ำไหล
		ctx.beginPath();
		ctx.moveTo(-50, 0);
		ctx.bezierCurveTo(-25, -20, 25, 20, 50, 0);
		ctx.stroke();
		...
		ctx.lineTo(650, 380);
		ctx.lineTo(588,420);
		ctx.fillStyle = "rgba(206, 172, 49, 1)";
		ctx.fill();
		ctx.stroke();
		...
		ctx.lineTo(650, 380);
		ctx.lineTo(650, 350);
		ctx.fillStyle = "rgba(73, 18, 191, 1)";
		ctx.fill();
		ctx.stroke();
		...
		ctx.fillStyle = "BROWN";		//ประตู
		ctx.fillRect(670,451, 20,50);
		...
		ctx.beginPath();		//ใบมะกรูดเเหละ
		ctx.moveTo(25, -20);
		ctx.quadraticCurveTo(65, -80, 25, -70);
		ctx.quadraticCurveTo(45, -100, 25, -100);
		ctx.quadraticCurveTo(40, -140, 0, -120);
		ctx.quadraticCurveTo(-20, -140, -25, -120);
		ctx.quadraticCurveTo(-45, -70, -25, -70);
		ctx.quadraticCurveTo(-65, -70, -25, -20);
		...
		ctx.moveTo(25, -20);
		ctx.quadraticCurveTo(65, -40, 25, -70);
		ctx.quadraticCurveTo(5, -80, 25, -100);
		ctx.quadraticCurveTo(40, -130, 0, -120);
		ctx.quadraticCurveTo(-20, -150, -25, -120);
		ctx.quadraticCurveTo(-65, -80, -25, -70);
		ctx.quadraticCurveTo(-65, -50, -25, -20);
		ctx.quadraticCurveTo(0, 40,25, -20);
